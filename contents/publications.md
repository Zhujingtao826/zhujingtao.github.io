...
observer gain, European Journal of Control. [Major Revision(2026.5.3)](本人一作 导师通讯)
...
- 基于电导率检测生菜无土栽培营养液各组分浓度装置和生长识别系统的设计（省级大创项目），已结题。

- 基于LangChain开发框架，微调大模型构建RAG应用（网址：itsayz.com）